    ...
    <Modal.Legacy open={visible} className="shadow-md shadow-accent">
      ...
      <Modal.Body>
        <p>
          ...
          <br /> In the meantime, feel free to explore more of my portfolio or
          connect with me on{" "}
          <a href={linkedinLink} rel='noopener noreferrer' target="_blank" className="text-cyan-400">
            LinkedIn
          </a>
          .<br /> Looking forward to chatting soon!
        </p>
